...
<head>
  ...
  <link rel="shortcut icon" href="spacewars.html" type="image/x-icon">
  <link rel="apple-touch-icon" sizes="180x180" href="steam/apps/1558930/header.jpg?t=1646147748">
  <link rel="icon" type="image/png" sizes="32x32" href="steam/apps/1558930/header.jpg?t=1646147748">
  <link rel="icon" type="image/png" sizes="16x16" href="steam/apps/1558930/header.jpg?t=1646147748">
  ...
  <meta content="Space Wars" property="og:title">
  <meta content="Created by master storytellers The Chinese Room, the complete version of this popular multi-award winning Apple Arcade game has been remastered for the big screen and includes all the bonus content from the original. A HERO WILL GO!
" property="og:description">
  <meta content="#ffffff" data-react-helmet="true" name="theme-color">
  <meta content='https://cdn.cloudflare.steamstatic.com/steam/apps/1558930/header.jpg?t=1646147748' property='og:image'>
  <meta property="og:image">
  <title>Space Wars</title>
  <link rel="stylesheet" href="css/rawline.css">
  <link rel="stylesheet" href="css2?family=Raleway:wght@300;400;500;600;700;800&amp;display=swap">
  <link rel="stylesheet"
    href="css2-1?family=Bebas+Neue&amp;family=Montserrat:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&amp;display=swap">
  <link rel="stylesheet" href="ajax/libs/font-awesome/6.0.0-beta2/css/all.min.css">
        ...
        <div class="navbar__branding">
          <a href="index.html">
            <svg id="logo" width="150" height="150" viewbox="0 0 130 130"
              xmlns="https://cdn.cloudflare.steamstatic.com/steam/apps/1558930/header.jpg?t=1646147748">
            </svg>
      ...
      <div class="main__container">
        <section class="section section--hero">
          ...
          <div class="section__container">
            <div class="section__content">
              <h1 class="section__heading">Space Wars</h1>
              <p class="section__subheading">The new best 2D Arcade Game...</p>
        ...
        <div>
          <section class="section section--about" id="section-about">
            <div class="section__container">
              <div class="section__content">
                <h2 class="section__heading">Privacy Policy</h2>
                <p class="section__description">
                  ...
                  device, named Space Wars

                  Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Space
                  Wars.
                  ...
                  store, use, process and transfer information about Your activity on Our Service in accordance with
                  ...
                  Their Privacy Policy can be viewed at https://spacewars-beta.tk/
